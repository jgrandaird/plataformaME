...
Class Macroactividad {
    ...
    public function index_seguimiento_pi($idproyecto, $idregional, $idperiodo) {
        ...
        foreach ($this->CI->Macroactividad_model->arrayMacroactividad as $macroactividad) {
            ...
            $cadenaEventos[$indice]=$this->obtener_cadena_id_eventos($arrayEventos);
        ...
        $arrayAutores=$this->CI->Personal_model->obtener_datos_persona();
        ...
        $data["arraySoportes"]=$arraySoportes; 
        $data["arregloPersonas"]=$arregloPersonas; 
        $data["arrayAutores"]=$arrayAutores; 
        $data["cadenaEventos"]=$cadenaEventos;
    ...
    //Concatena en una cadena los id de los eventos
    function obtener_cadena_id_eventos($objEvento){
        ...
        foreach ($objEvento->result() as $evento) {
            ...
            $indiceEvento = $evento->id;
            $cadenaIdEventos=$cadenaIdEventos.$coma.$indiceEvento;
            $coma=",";
            
        }
        return $cadenaIdEventos;
