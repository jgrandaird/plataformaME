...
class SeguimientoPI_controller extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->clase["Novedad"] = new Novedad;
        ...
        $this->menuIndex["Novedad"] = "cargar_menu_index_novedad";
    ...
    public function nueva_notificacion($idevento,$idpersona){
        $this->modulo = 'Novedad';
        $this->clase[$this->modulo]->guardar_registro($idevento,$idpersona);
    ...
    public function cargar_menu_index_novedad(){
