...
//</editor-fold>
class TableroControl_controller extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->menu->rutaModulo = "Autocontrol/TableroControl_controller/";
    ...
    Public function index_tablero_control($idregistro) {
        ...
        $this->clase[$this->modulo]->encabezado = $this->encabezado;
        $this->clase[$this->modulo]->index_tablero_control($idregistro, $this->session->userdata("idregional_funcionario"), 7);
    }
    ...
    Public function cambiar_periodo($idproyecto, $idperiodo) {
        ...
        $this->clase[$this->modulo]->encabezado = $this->encabezado;
        $this->clase[$this->modulo]->index_tablero_control($idproyecto, $this->session->userdata("idregional_funcionario"), $idperiodo);
    }
    ...
    public function cargar_menu_index_proyecto() {
        ...
        $opcionesMenu[$indice]["Funcion"] = base_url() . $this->menu->rutaModulo . "index_tablero_control";
        $opcionesMenu[$indice]["Imagen"] = base_url() . "img/tablerocontrol.png";
        $opcionesMenu[$indice]["Identificador"] = "Tablero_Lista";
